=====================================
Neural Causal Models (NCM) In PyTorch
=====================================
PyTorch causal deep learning.
...
.. code-block::
  ...
  $ pytest tests
  $ ncm train -c experiments/config.yml
...
.. code-block::
  ...
  ncm train -c experiments/config.yml -r path/to/checkpoint
